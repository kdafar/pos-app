...
export const adminStrings = {
  ...
  'permissions.appliesToNobody': { en: 'No active users hold this role yet', ar: 'لا يوجد مستخدمون نشطون بهذا الدور' },
  'permissions.ownRoleReadOnly': { en: 'This is your own role. Its permissions are shown for reference and cannot be changed here — editing them could lock you out of this screen.', ar: 'هذا دورك الحالي. تظهر صلاحياته للمراجعة ولا يمكن تغييرها من هنا، فقد يؤدي ذلك إلى منعك من الوصول إلى هذه الشاشة.' },
  'permissions.yourRole': { en: 'Your role', ar: 'دورك' },
  'permissions.noRoles': { en: 'No roles are available.', ar: 'لا توجد أدوار متاحة.' },
  ...
  'permissions.membersLabel': { en: 'Users with this role', ar: 'المستخدمون بهذا الدور' },
  ...
  'permissions.orders.print': { en: 'Print receipts', ar: 'طباعة الفواتير' },
  ...
  'admin.rep.printThermal': { en: 'Print Thermal', ar: 'طباعة حرارية' },
  'admin.rep.thermalTitle': { en: 'Closing Report', ar: 'تقرير الإغلاق' },
  'admin.rep.thermalCounts': { en: 'Order counts', ar: 'عدد الطلبات' },
  'admin.rep.thermalTotalOrders': { en: 'Total orders', ar: 'إجمالي الطلبات' },
  'admin.rep.thermalGeneratedAt': { en: 'Printed at', ar: 'وقت الطباعة' },
  'admin.rep.thermalGeneratedBy': { en: 'Printed by', ar: 'بواسطة' },
  'admin.rep.thermalOrders': { en: 'Orders', ar: 'الطلبات' },
  'admin.rep.thermalSignature': { en: 'Cashier signature', ar: 'توقيع الكاشير' },
  'admin.rep.thermalFailed': {
    en: 'Could not print the report on the thermal printer. Check the printer in Settings, then try again.',
    ar: 'تعذرت طباعة التقرير على الطابعة الحرارية. تحقق من الطابعة في الإعدادات ثم أعد المحاولة.',
  },

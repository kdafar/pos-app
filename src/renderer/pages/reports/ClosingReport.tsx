    ...
    <div className="p-4 md:p-6 space-y-12">
      <header className="flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <button onClick={printNow} className={`px-3 py-2 rounded-lg text-sm inline-flex items-center gap-1.5 ${chipBg}`} title="Print">
      ...
      {/* Filters */}
      <section className={`border ${panel} rounded-xl p-4`}>
